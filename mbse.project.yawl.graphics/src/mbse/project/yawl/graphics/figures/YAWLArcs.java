...
//			Border b = targetDecorator.getBorder();
//			b.getPreferredSize(targetDecorator);
//			b.getInsets(targetDecorator);
//			targetDecorator.setBorder(b);
						
//			PointList pointlist = targetDecorator.getPoints();
//			pointlist.addPoint(pointlist.getFirstPoint().getTranslated(2, 0));
//			pointlist.addPoint(pointlist.getLastPoint().getTranslated(2, 0));
//			pointlist.addPoint(pointlist.getMidpoint().getTranslated(2, 0));			
//			targetDecorator.setPoints(pointlist);			
