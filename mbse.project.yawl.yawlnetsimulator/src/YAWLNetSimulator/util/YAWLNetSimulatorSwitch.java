 ...
 * @generated
 */
public class YAWLNetSimulatorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case YAWLNetSimulatorPackage.ENABLED_TRANSITION: {
			...
			case YAWLNetSimulatorPackage.WARNING: {
				Warning warning = (Warning)theEObject;
				T result = caseWarning(warning);
				if (result == null) result = caseObjectAnnotation(warning);
				if (result == null) result = caseAnnotation(warning);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case YAWLNetSimulatorPackage.SELECT_ARC: {
			...
			case YAWLNetSimulatorPackage.MARKING: {
