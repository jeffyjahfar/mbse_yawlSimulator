 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see YAWLNetSimulator.YAWLNetSimulatorFactory
 * @model kind="package"
 * @generated
 */
public interface YAWLNetSimulatorPackage extends EPackage {
	/**
	 * The package name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	String eNS_URI = "http://mbse/project/yawlnets/simulator";
	 ...
	 * @generated
	 */
	String eNS_PREFIX = "yawlnetsimulator";
	 ...
	 * @generated
	 */
	YAWLNetSimulatorPackage eINSTANCE = YAWLNetSimulator.impl.YAWLNetSimulatorPackageImpl.init();

	/**
	 * The meta object id for the '{@link YAWLNetSimulator.impl.EnabledTransitionImpl <em>Enabled Transition</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see YAWLNetSimulator.impl.EnabledTransitionImpl
	 * @see YAWLNetSimulator.impl.YAWLNetSimulatorPackageImpl#getEnabledTransition()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link YAWLNetSimulator.impl.WarningImpl <em>Warning</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see YAWLNetSimulator.impl.WarningImpl
	 * @see YAWLNetSimulator.impl.YAWLNetSimulatorPackageImpl#getWarning()
	 * @generated
	 */
	int WARNING = 1;
	 ...
	 * @ordered
	 */
	int WARNING__NET_ANNOTATIONS = NetannotationsPackage.OBJECT_ANNOTATION__NET_ANNOTATIONS;
	 ...
	 * @ordered
	 */
	int WARNING__OBJECT = NetannotationsPackage.OBJECT_ANNOTATION__OBJECT;
	 ...
	 * @ordered
	 */
	int WARNING_FEATURE_COUNT = NetannotationsPackage.OBJECT_ANNOTATION_FEATURE_COUNT + 0;

	/**
	 * The meta object id for the '{@link YAWLNetSimulator.impl.SelectArcImpl <em>Select Arc</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see YAWLNetSimulator.impl.SelectArcImpl
	 * @see YAWLNetSimulator.impl.YAWLNetSimulatorPackageImpl#getSelectArc()
	 * @generated
	 */
	int SELECT_ARC = 2;
	...
	/**
	 * The meta object id for the '{@link YAWLNetSimulator.impl.MarkingImpl <em>Marking</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see YAWLNetSimulator.impl.MarkingImpl
	 * @see YAWLNetSimulator.impl.YAWLNetSimulatorPackageImpl#getMarking()
	 * @generated
	 */
	int MARKING = 3;
	...
	/**
	 * Returns the meta object for class '{@link YAWLNetSimulator.EnabledTransition <em>Enabled Transition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Enabled Transition</em>'.
	 * @see YAWLNetSimulator.EnabledTransition
	 * @generated
	 */
	EClass getEnabledTransition();

	/**
	 * Returns the meta object for the reference list '{@link YAWLNetSimulator.EnabledTransition#getInArcs <em>In Arcs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference list '{@link YAWLNetSimulator.EnabledTransition#getOutArcs <em>Out Arcs</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link YAWLNetSimulator.Warning <em>Warning</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Warning</em>'.
	 * @see YAWLNetSimulator.Warning
	 * @generated
	 */
	EClass getWarning();

	/**
	 * Returns the meta object for class '{@link YAWLNetSimulator.SelectArc <em>Select Arc</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Select Arc</em>'.
	 * @see YAWLNetSimulator.SelectArc
	 * @generated
	 */
	EClass getSelectArc();

	/**
	 * Returns the meta object for the attribute '{@link YAWLNetSimulator.SelectArc#isSelected <em>Selected</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Selected</em>'.
	 * @see YAWLNetSimulator.SelectArc#isSelected()
	 * @see #getSelectArc()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link YAWLNetSimulator.SelectArc#getTargetTransition <em>Target Transition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link YAWLNetSimulator.SelectArc#getSourceTransition <em>Source Transition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link YAWLNetSimulator.Marking <em>Marking</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Marking</em>'.
	 * @see YAWLNetSimulator.Marking
	 * @generated
	 */
	EClass getMarking();

	/**
	 * Returns the meta object for the attribute '{@link YAWLNetSimulator.Marking#getValue <em>Value</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Value</em>'.
	 * @see YAWLNetSimulator.Marking#getValue()
	 * @see #getMarking()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	YAWLNetSimulatorFactory getYAWLNetSimulatorFactory();
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link YAWLNetSimulator.impl.EnabledTransitionImpl <em>Enabled Transition</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see YAWLNetSimulator.impl.EnabledTransitionImpl
		 * @see YAWLNetSimulator.impl.YAWLNetSimulatorPackageImpl#getEnabledTransition()
		...
		/**
		 * The meta object literal for the '{@link YAWLNetSimulator.impl.WarningImpl <em>Warning</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see YAWLNetSimulator.impl.WarningImpl
		 * @see YAWLNetSimulator.impl.YAWLNetSimulatorPackageImpl#getWarning()
		...
		/**
		 * The meta object literal for the '{@link YAWLNetSimulator.impl.SelectArcImpl <em>Select Arc</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see YAWLNetSimulator.impl.SelectArcImpl
		 * @see YAWLNetSimulator.impl.YAWLNetSimulatorPackageImpl#getSelectArc()
		...
		/**
		 * The meta object literal for the '{@link YAWLNetSimulator.impl.MarkingImpl <em>Marking</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see YAWLNetSimulator.impl.MarkingImpl
		 * @see YAWLNetSimulator.impl.YAWLNetSimulatorPackageImpl#getMarking()
