 ...
 * </p>
 * <ul>
 *   <li>{@link YAWLNetSimulator.impl.MarkingImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MarkingImpl extends ObjectAnnotationImpl implements Marking {
	...
	protected EClass eStaticClass() {
		return YAWLNetSimulatorPackage.Literals.MARKING;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YAWLNetSimulatorPackage.MARKING__VALUE, oldValue, value));
	}
	...
	public EAttribute getAnnotationAttribute() {
		...
		return YAWLNetSimulatorPackage.eINSTANCE.getMarking_Value();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YAWLNetSimulatorPackage.MARKING__VALUE:
				return getValue();
		}
