 ...
 * </p>
 * <ul>
 *   <li>{@link YAWLNetSimulator.impl.SelectArcImpl#isSelected <em>Selected</em>}</li>
 *   <li>{@link YAWLNetSimulator.impl.SelectArcImpl#getTargetTransition <em>Target Transition</em>}</li>
 *   <li>{@link YAWLNetSimulator.impl.SelectArcImpl#getSourceTransition <em>Source Transition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelectArcImpl extends ObjectAnnotationImpl implements SelectArc {
	...
	protected EClass eStaticClass() {
		return YAWLNetSimulatorPackage.Literals.SELECT_ARC;
	}
	...
	public void setSelected(boolean newSelected) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YAWLNetSimulatorPackage.SELECT_ARC__SELECTED, oldSelected, selected));
	}
	...
	public EnabledTransition getTargetTransition() {
		if (targetTransition != null && targetTransition.eIsProxy()) {
			...
			if (targetTransition != oldTargetTransition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YAWLNetSimulatorPackage.SELECT_ARC__TARGET_TRANSITION, oldTargetTransition, targetTransition));
			}
		}
	...
	public NotificationChain basicSetTargetTransition(EnabledTransition newTargetTransition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, YAWLNetSimulatorPackage.SELECT_ARC__TARGET_TRANSITION, oldTargetTransition, newTargetTransition);
	...
	public void setTargetTransition(EnabledTransition newTargetTransition) {
		if (newTargetTransition != targetTransition) {
			...
			if (targetTransition != null)
				msgs = ((InternalEObject)targetTransition).eInverseRemove(this, YAWLNetSimulatorPackage.ENABLED_TRANSITION__IN_ARCS, EnabledTransition.class, msgs);
			if (newTargetTransition != null)
				msgs = ((InternalEObject)newTargetTransition).eInverseAdd(this, YAWLNetSimulatorPackage.ENABLED_TRANSITION__IN_ARCS, EnabledTransition.class, msgs);
			msgs = basicSetTargetTransition(newTargetTransition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YAWLNetSimulatorPackage.SELECT_ARC__TARGET_TRANSITION, newTargetTransition, newTargetTransition));
	}
	...
	public EnabledTransition getSourceTransition() {
		if (sourceTransition != null && sourceTransition.eIsProxy()) {
			...
			if (sourceTransition != oldSourceTransition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, YAWLNetSimulatorPackage.SELECT_ARC__SOURCE_TRANSITION, oldSourceTransition, sourceTransition));
			}
		}
	...
	public NotificationChain basicSetSourceTransition(EnabledTransition newSourceTransition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, YAWLNetSimulatorPackage.SELECT_ARC__SOURCE_TRANSITION, oldSourceTransition, newSourceTransition);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSourceTransition(EnabledTransition newSourceTransition) {
		if (newSourceTransition != sourceTransition) {
			...
			if (sourceTransition != null)
				msgs = ((InternalEObject)sourceTransition).eInverseRemove(this, YAWLNetSimulatorPackage.ENABLED_TRANSITION__OUT_ARCS, EnabledTransition.class, msgs);
			if (newSourceTransition != null)
				msgs = ((InternalEObject)newSourceTransition).eInverseAdd(this, YAWLNetSimulatorPackage.ENABLED_TRANSITION__OUT_ARCS, EnabledTransition.class, msgs);
			msgs = basicSetSourceTransition(newSourceTransition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YAWLNetSimulatorPackage.SELECT_ARC__SOURCE_TRANSITION, newSourceTransition, newSourceTransition));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case YAWLNetSimulatorPackage.SELECT_ARC__TARGET_TRANSITION:
				if (targetTransition != null)
					msgs = ((InternalEObject)targetTransition).eInverseRemove(this, YAWLNetSimulatorPackage.ENABLED_TRANSITION__IN_ARCS, EnabledTransition.class, msgs);
				return basicSetTargetTransition((EnabledTransition)otherEnd, msgs);
			case YAWLNetSimulatorPackage.SELECT_ARC__SOURCE_TRANSITION:
				if (sourceTransition != null)
					msgs = ((InternalEObject)sourceTransition).eInverseRemove(this, YAWLNetSimulatorPackage.ENABLED_TRANSITION__OUT_ARCS, EnabledTransition.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YAWLNetSimulatorPackage.SELECT_ARC__SELECTED:
				return isSelected();
			case YAWLNetSimulatorPackage.SELECT_ARC__TARGET_TRANSITION:
