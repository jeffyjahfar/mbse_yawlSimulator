 ...
 * </p>
 * <ul>
 *   <li>{@link YAWLNetSimulator.impl.EnabledTransitionImpl#getInArcs <em>In Arcs</em>}</li>
 *   <li>{@link YAWLNetSimulator.impl.EnabledTransitionImpl#getOutArcs <em>Out Arcs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnabledTransitionImpl extends ObjectAnnotationImpl implements EnabledTransition {
	...
	protected EClass eStaticClass() {
		return YAWLNetSimulatorPackage.Literals.ENABLED_TRANSITION;
	}
	...
	public EList<SelectArc> getInArcs() {
		if (inArcs == null) {
			inArcs = new EObjectWithInverseResolvingEList<SelectArc>(SelectArc.class, this, YAWLNetSimulatorPackage.ENABLED_TRANSITION__IN_ARCS, YAWLNetSimulatorPackage.SELECT_ARC__TARGET_TRANSITION);
		}
		return inArcs;
	}
	...
	public EList<SelectArc> getOutArcs() {
		if (outArcs == null) {
			outArcs = new EObjectWithInverseResolvingEList<SelectArc>(SelectArc.class, this, YAWLNetSimulatorPackage.ENABLED_TRANSITION__OUT_ARCS, YAWLNetSimulatorPackage.SELECT_ARC__SOURCE_TRANSITION);
		}
		return outArcs;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case YAWLNetSimulatorPackage.ENABLED_TRANSITION__IN_ARCS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getInArcs()).basicAdd(otherEnd, msgs);
			case YAWLNetSimulatorPackage.ENABLED_TRANSITION__OUT_ARCS:
