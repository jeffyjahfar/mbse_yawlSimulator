 ...
 * </p>
 * <ul>
 *   <li>{@link mbse.project.YAWLnets.impl.ArcTypeImpl#getText <em>Text</em>}</li>
 *   <li>{@link mbse.project.YAWLnets.impl.ArcTypeImpl#getArc <em>Arc</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArcTypeImpl extends AttributeImpl implements ArcType {
	...
	protected EClass eStaticClass() {
		return YAWLnetsPackage.Literals.ARC_TYPE;
	}
	 ...
	 */
	public Arc getArc() {
		if (eContainerFeatureID() != YAWLnetsPackage.ARC_TYPE__ARC) return null;
	...
	public NotificationChain basicSetArc(Arc newArc, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newArc, YAWLnetsPackage.ARC_TYPE__ARC, msgs);
		return msgs;
	}
	...
	public void setArc(Arc newArc) {
		if (newArc != eInternalContainer() || (eContainerFeatureID() != YAWLnetsPackage.ARC_TYPE__ARC && newArc != null)) {
			...
			if (newArc != null)
				msgs = ((InternalEObject)newArc).eInverseAdd(this, YAWLnetsPackage.ARC__TYPE, Arc.class, msgs);
			msgs = basicSetArc(newArc, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YAWLnetsPackage.ARC_TYPE__ARC, newArc, newArc));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case YAWLnetsPackage.ARC_TYPE__ARC:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case YAWLnetsPackage.ARC_TYPE__ARC:
				return eInternalContainer().eInverseRemove(this, YAWLnetsPackage.ARC__TYPE, Arc.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case YAWLnetsPackage.ARC_TYPE__TEXT:
				return getText();
			case YAWLnetsPackage.ARC_TYPE__ARC:
				return getArc();
		}
	...
	public void setText(ArcTypes newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YAWLnetsPackage.ARC_TYPE__TEXT, oldText, text));
	}
