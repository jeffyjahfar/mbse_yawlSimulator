 ...
 * @generated
 */
public class YAWLnetsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case YAWLnetsPackage.TRANSITION: {
			...
			case YAWLnetsPackage.PLACE_MARKING: {
				PlaceMarking placeMarking = (PlaceMarking)theEObject;
				T result = casePlaceMarking(placeMarking);
				if (result == null) result = caseAttribute(placeMarking);
				if (result == null) result = caseLabel(placeMarking);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case YAWLnetsPackage.SPLIT_TYPE: {
			...
			case YAWLnetsPackage.JOIN_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>YAW Lnet</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>YAW Lnet</em>'.
